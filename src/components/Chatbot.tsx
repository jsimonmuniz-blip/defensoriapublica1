...
const GREETING =
  "¡Hola! 👋 Soy **Defensa Virtual** del Instituto de Defensoría Pública de Nuevo León. Para orientarte con la oficina y los servicios que te corresponden, cuéntame: **¿de qué municipio nos escribes?**";
        ...
        <AnimatePresence>
          {!open && (
            <motion.button
              ...
              aria-label="Abrir Defensa Virtual"
              className="relative flex h-16 w-16 items-center justify-center rounded-full bg-gradient-primary shadow-glow"
            >
              <img src={dipi} alt="Defensa Virtual" className="h-12 w-12 object-contain drop-shadow" />
            </motion.button>
          )}
        </AnimatePresence>
      </div>
          ...
          >
            ...
            <div className="flex items-center gap-3 bg-gradient-navy px-4 py-3.5 text-navy-foreground">
              <div className="flex h-11 w-11 items-center justify-center rounded-full bg-white/15 p-1">
                <img src={dipi} alt="Defensa Virtual" className="h-9 w-9 object-contain" />
              </div>
              <div className="flex-1">
                <p className="font-display text-base font-bold leading-none">Defensa Virtual</p>
